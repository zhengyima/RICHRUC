...
public class Position_5 extends JDialog implements ActionListener
{
	...
	{	
	    ...
	    if(Position_5.color=="red"){
	    	if(PlayerOne.step==5){
	    		if(Position_5.type=="park"){
		            ...
		            if(Position_5.a==0){
		            	if(Position_5.type=="hotel"){
		            		...
		            		if(Position_5.level==1){
		            			...
		            			Position_5.image1=MainMap.tyr3;
		            			Position_5.x1=400;
		            			Position_5.y1=138;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			Position_5.image1=MainMap.tyr4;
		            			Position_5.x1=419;
		            			Position_5.y1=162;
    		                    Position_5.level=4;
    	                        Position_6.level=4;  
		            			...
		            			Position_5.image1=MainMap.tyr5;
		            			Position_5.x1=405;
		            			Position_5.y1=122;
		            			Position_5.level=5;
		            			Position_6.level=5;
		            		...
		            		else if(Position_5.level==5){	
		            		}
		            	}
		            	else if(Position_5.type=="graduate"){
		            		if(Position_5.level==1){
		            			...
		            			Position_5.image1=MainMap.gdr2;
		            			Position_5.x1=422;Position_5.y1=105;
    		                    Position_5.level=2;
    	                        Position_6.level=2;
    	                        MainMap.baozi1=0;
		            			...
		            			Position_5.image1=MainMap.gdr3;
		            			Position_5.x1=420;
		            			Position_5.y1=89;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			Position_5.image1=MainMap.gdr4;
		            			Position_5.x1=420;
		            			Position_5.y1=100;
    		                    Position_5.level=4;
    	                        Position_6.level=4;
		            			...
		            			Position_5.image1=MainMap.gdr5;
		            			Position_5.x1=420;
		            			Position_5.y1=76;
    		                    Position_5.level=5;
    	                        Position_6.level=5; 
		            		...
		            		if(Position_5.level==1){
		            			...
		            			Position_5.image1=MainMap.red4;
		            			Position_5.x1=420;
		            			Position_5.y1=80;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			Position_5.image1=MainMap.red5;
		            			Position_5.x1=420;
		            			Position_5.y1=24;
    		                    Position_5.level=4;
    	                        Position_6.level=4;
		            			...
		            			Position_5.image1=MainMap.red6;
		            			Position_5.x1=420;
		            			Position_5.y1=-10;
    		                    Position_5.level=5;
    	                        Position_6.level=5;
	    		...
	    		if(Position_5.type=="park"){
		            ...
		            if(Position_5.a==0){
		            	if(Position_5.type=="hotel"){
		            		if(Position_5.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到2级，花费700知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.lgb2;
		            			Position_5.x1=415;
		            			Position_5.y1=150;
    		                    Position_5.level=2;
    	                        Position_6.level=2;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到3级，花费1000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.lgb3;
		            			Position_5.x1=415;
		            			Position_5.y1=88;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到4级，花费1500知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.lgb4;
		            			Position_5.x1=376;
		            			Position_5.y1=40;
    		                    Position_5.level=4;
    	                        Position_6.level=4; 
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到5级，花费2000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.lgb5;
		            			Position_5.x1=412;
		            			Position_5.y1=37;
    		                    Position_5.level=5;
    	                        Position_6.level=5;
		            		...
		            		if(Position_5.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到2级，花费900知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.tyb2;
		            			Position_5.x1=419;
		            			Position_5.y1=161;
    		                    Position_5.level=2;
    	                        Position_6.level=2;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到3级，花费1100知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.tyb3;
		            			Position_5.x1=400;
		            			Position_5.y1=138;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到4级，花费2500知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.tyb4;
		            			Position_5.x1=419;
		            			Position_5.y1=162;
    		                    Position_5.level=4;
    	                        Position_6.level=4;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到5级，花费4000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.tyb5;
		            			Position_5.x1=405;
		            			Position_5.y1=122;
    		                    Position_5.level=5;
    	                        Position_6.level=5;
		            		...
		            		if(Position_5.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"获得拖堂卡一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到2级，花费400知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.gdb2;
		            			Position_5.x1=422;
		            			Position_5.y1=105;
    		                    Position_5.level=2;
    	                        Position_6.level=2;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"获得拖堂卡一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到3级，花费500知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.gdb3;
		            			Position_5.x1=420;
		            			Position_5.y1=89;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"获得考试周卡一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到4级，花费700知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.gdb4;
		            			Position_5.x1=420;Position_5.y1=100;
    		                    Position_5.level=4;
    	                        Position_6.level=4;
    	                        MainMap.shoulei2=0;
    	                        PlayerTwo.Points=PlayerTwo.Points-700;	
		            			...
		            			Position_5.image1=MainMap.gdb5;
		            			Position_5.x1=420;
		            			Position_5.y1=76;
    		                    Position_5.level=5;
    	                        Position_6.level=5;
		            		...
		            		if(Position_5.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到2级，花费2000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.red33;
		            			Position_5.x1=420;
		            			Position_5.y1=120;
    		                    Position_5.level=2;
    	                        Position_6.level=2;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到3级，花费3000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.red44;
		            			Position_5.x1=420;
		            			Position_5.y1=80;
    		                    Position_5.level=3;
    	                        Position_6.level=3;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到4级，花费5000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.red55;
		            			Position_5.x1=420;
		            			Position_5.y1=24;
    		                    Position_5.level=4;
    	                        Position_6.level=4;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到5级，花费6000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_5.image1=MainMap.red66;
		            			Position_5.x1=420;Position_5.y1=-10;
    		                    Position_5.level=5;
    	                        Position_6.level=5;
	    	...
	    	if(PlayerOne.step<50&&PlayerTwo.step<50){
	    		...
	    		h1.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				...
	    				Position_6.level=1;
	    				if(PlayerOne.step==5){
	    					Position_5.image1=MainMap.red1;
	    					PlayerOne.Points=PlayerOne.Points-500;
	    					Position_5.color="red";
	    					Position_6.color="red";
	    				}
	    				else if(PlayerTwo.step==5){
	    					Position_5.image1=MainMap.red11;
	    		...
	    		h2.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				...
	    				Position_6.level=1;
	    				if(PlayerOne.step==5){
	    					Position_5.image1=MainMap.tiyu1;
	    					Position_5.color="red";
	    					Position_6.color="red";
	    					PlayerOne.Points=PlayerOne.Points-900;
					    }
	    				else if(PlayerTwo.step==5){
	    					Position_5.image1=MainMap.tiyu2;
	    					Position_5.color="blue";
	    					Position_6.color="blue";
	    					PlayerTwo.Points=PlayerTwo.Points-900;
				        }
	    		...
	    		h3.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				...
	    				if(PlayerOne.step==5){
	    					Position_5.color="red";
	    					Position_6.color="red";
	    					Position_5.image1=MainMap.park1;
	    				}
	    				else if(PlayerTwo.step==5){
	    					Position_5.color="blue";
	    					Position_6.color="blue";
	    					Position_5.image1=MainMap.park2;
	    				}
	    			}
	    		});
	    		...
	    		h4.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				...
	    				MainMap.choose=1;
	    				setVisible(false);Position_5.level=1;
	    				Position_6.level=1;
	    				if(PlayerOne.step==5){
	    					Position_5.color="red";
	    					Position_6.color="red";
	    					Position_5.image1=MainMap.gdt1;
	    					PlayerOne.Points=PlayerOne.Points-300;
	    				}
	    				else if(PlayerTwo.step==5){
	    					Position_5.color="blue";
	    					Position_6.color="blue";
	    					Position_5.image1=MainMap.gdt2;
		...
		h5.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				MainMap.choose=1;setVisible(false);
				Position_5.level=1;Position_6.level=1;
				if(PlayerOne.step==5){
					Position_5.color="red";
					Position_6.color="red";
					Position_5.image1=MainMap.red2;
					PlayerOne.Points=PlayerOne.Points-1000;
			    }
				else if(PlayerTwo.step==5){
					Position_5.color="blue";
					Position_6.color="blue";
					Position_5.image1=MainMap.red22;
					PlayerTwo.Points=PlayerTwo.Points-1000;
				}
			}
		});
	...
	public static void drawCX7Image(Graphics g){
    	g.drawImage(Position_5.image1,Position_5.x1,Position_5.y1,null);
    }
}