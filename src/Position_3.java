...
public class Position_3 extends JOptionPane{
	...
	public Position_3(){	
		if(this.color=="red"){
	    	a=this.showConfirmDialog(null,"是否升级公共教学二楼？","",JOptionPane.YES_NO_OPTION);
	    }else if(this.color=="blue"){
	    	a=this.showConfirmDialog(null,"是否升级公共教学二楼？","",JOptionPane.YES_NO_OPTION);
	    }else{
	    	a=this.showConfirmDialog(null,"是否购买公共教学二楼？","",JOptionPane.YES_NO_OPTION);
	    }
	...
	public static void Po3(){
		if(PlayerOne.step==3){	
			if(Position_3.color=="red"){
				if(Position_3.a==0){
					if(Position_3.level==1){
						a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到1级，花费500知识点","",JOptionPane.DEFAULT_OPTION);
						Position_3.image1=red2;
						Position_3.x1=351;Position_3.y1=350;
						Position_3.x2=126;Position_3.y2=94;
						Position_3.level=2;
						PlayerOne.Points=PlayerOne.Points-500;
					}
					else if(Position_3.level==2){
						a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到2级，花费1000知识点","",JOptionPane.DEFAULT_OPTION);
						Position_3.x2=128;Position_3.y2=112;
						Position_3.level=3;
						PlayerOne.Points=PlayerOne.Points-1000;
					}
					else if(Position_3.level==3){
						a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到3级，花费1500知识点","",JOptionPane.DEFAULT_OPTION);
						Position_3.image1=red4;
						Position_3.x1=351;Position_3.y1=325;
						Position_3.x2=127;Position_3.y2=120;
						Position_3.level=4;
						PlayerOne.Points=PlayerOne.Points-1500;
					}
			 		else if(Position_3.level==4){
			 			a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到4级，花费2500知识点","",JOptionPane.DEFAULT_OPTION);
			 			Position_3.image1=red5;
						Position_3.x1=351;Position_3.y1=312;
						Position_3.x2=125;Position_3.y2=136;
						Position_3.level=5;
						PlayerOne.Points=PlayerOne.Points-2500;
			 		}
			 		else if(Position_3.level==5){
			 			a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到5级，花费3500知识点","",JOptionPane.DEFAULT_OPTION);
			 			Position_3.image1=red6;
			 			Position_3.x1=351;Position_3.y1=294;
			 			Position_3.x2=127;Position_3.y2=153;
    		         	Position_3.level=6;
				...
				if(PlayerTwo.blood>0){
					if(Position_3.level==1){
	    	            ...
	    	            a=JOptionPane.showConfirmDialog(null,"在教二学习，被小美吸收"+(int)temp+"知识点","",JOptionPane.DEFAULT_OPTION);
					}
					else if(Position_3.level==2){
				...
				if(Position_3.a==0){
					a=JOptionPane.showConfirmDialog(null,"购买公共教学二楼花费300知识点","",JOptionPane.DEFAULT_OPTION);
					Position_3.image1=red1;
					Position_3.x1=351;Position_3.y1=349;
					Position_3.x2=126;Position_3.y2=94;
					Position_3.level=1;
					Position_3.color="red";
		...
		if(Position_3.color=="blue"){
			if(Position_3.a==0){
    	       if(Position_3.level==1){
    	    	   ...
    	    	   a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到2级，花费1000知识点","",JOptionPane.DEFAULT_OPTION);
    	    	   Position_3.image1=red33;
    	    	   Position_3.x1=351;Position_3.y1=334;
    	    	   Position_3.x2=128;Position_3.y2=112;
    	    	   Position_3.level=3;
            	   ...
            	   a=JOptionPane.showConfirmDialog(null,"升级公共教学二楼到5级，花费3500知识点","",JOptionPane.DEFAULT_OPTION);
            	   Position_3.image1=red66;Position_3.x1=352;Position_3.y1=294;
            	   Position_3.x2=127;Position_3.y2=153;
            	   Position_3.level=6;
		...
		else if(Position_3.color=="red"){
			if(PlayerOne.blood>0){
				if(Position_3.level==1){
					double temp=(PlayerOne.GPA-PlayerTwo.GPA+1)*800;
    	            PlayerOne.Points=PlayerOne.Points+(int)temp;
    	            PlayerTwo.Points=PlayerTwo.Points-(int)temp;
    	            a=JOptionPane.showConfirmDialog(null,"在教二学习，被小强吸收"+(int)temp+"知识点","",JOptionPane.DEFAULT_OPTION);
				}
				else if(Position_3.level==2){
		...
		if(Position_3.a==0){
			a=JOptionPane.showConfirmDialog(null,"购买公共教学二楼花费300知识点","",JOptionPane.DEFAULT_OPTION);
			Position_3.image1=red11;
			Position_3.x1=351;Position_3.y1=349;
			Position_3.x2=126;Position_3.y2=94;
			Position_3.level=1;
			Position_3.color="blue";
	...
	public static void drawCX2Image(Graphics g){
    	g.drawImage(Position_3.image1,Position_3.x1,Position_3.y1,Position_3.x2,Position_3.y2,null);
    }
}