...
public class Position_12 extends JDialog implements ActionListener{
	...
	public Position_12(){	
	    ...
	    if(Position_12.color=="red"){
	    	if(PlayerOne.step==12){
	    		if(Position_12.type=="park"){
		           	...
		           	if(Position_12.type=="hotel"){
		            	 if(Position_12.level==1){
		           		...
		           		if(Position_12.level==1){
		           			...
		           			Position_12.image1=MainMap.tyr3;
		           			Position_12.x1=1012;Position_12.y1=187;
		           			Position_11.level=3;
		           			Position_12.level=3;
		           			...
		           			Position_12.image1=MainMap.tyr4;
		           			Position_12.x1=1025;Position_12.y1=211;
		           			Position_11.level=4;
		           			Position_12.level=4;
		           			...
		           			Position_12.image1=MainMap.tyr5;
		           			Position_12.x1=1022;Position_12.y1=171;
		           			Position_11.level=5;
		           			Position_12.level=5;
		           			PlayerOne.Points=PlayerOne.Points-4000;
		           		}
		           		else if(Position_12.level==5){	
		           		}
		           	}
		           	else if(Position_12.type=="graduate"){
		           		if(Position_12.level==1){
		           			...
		           			Position_12.image1=MainMap.gdr2;
		           			Position_12.x1=1029;Position_12.y1=158;
		           			Position_11.level=2;
		           			Position_12.level=2;
		           			MainMap.baozi1=0;
		           			...
		           			Position_12.image1=MainMap.gdr3;
		           			Position_12.x1=1029;Position_12.y1=135;
		           			Position_11.level=3;
		           			Position_12.level=3;
		           			MainMap.baozi1=0;
		           			...
		           			Position_12.image1=MainMap.gdr4;
		           			Position_12.x1=1029;Position_12.y1=145;
		           			Position_11.level=4;
		           			Position_12.level=4;
		           			MainMap.shoulei1=0;
		           			PlayerOne.Points=PlayerOne.Points-700;	
		           			...
		           			Position_12.image1=MainMap.gdr5;
		           			Position_12.x1=1029;Position_12.y1=120;
		           			Position_11.level=5;
		           			Position_12.level=5;
		           			MainMap.shaizi1=0;
		            	...
		            	else if(Position_12.type=="shop"){
		            		if(Position_12.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到2级，花费2000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.red3;
		            			Position_12.x1=1029;Position_12.y1=164;
    		                    Position_11.level=2;
    	                        Position_12.level=2;
    	                        PlayerOne.Points=PlayerOne.Points-2000;	
		            		}
		            			...
		            			Position_12.image1=MainMap.red4;
		            			Position_12.x1=1029;Position_12.y1=133;
    		                    Position_11.level=3;
    	                        Position_12.level=3;
		            			...
		            			Position_12.image1=MainMap.red5;
		            			Position_12.x1=1029;Position_12.y1=71;
    		                    Position_11.level=4;
    	                        Position_12.level=4;
    	                        PlayerOne.Points=PlayerOne.Points-5000;	
		            		}
		            			...
		            			Position_12.image1=MainMap.red6;
		            			Position_12.x1=1028;Position_12.y1=39;
    		                    Position_11.level=5;
    	                        Position_12.level=5;
	    		...
	    		else if(Position_12.type=="hotel"){
	    ...
	    else if(Position_12.color=="blue"){
	    	if(PlayerTwo.step==12){
	    		if(Position_12.type=="park"){
	    			a=JOptionPane.showConfirmDialog(null,"小红在百家廊休息","",JOptionPane.DEFAULT_OPTION);
	    		}
	    		else{
		            ...
		            if(Position_12.a==0){
		            	if(Position_12.type=="hotel"){
		            		if(Position_12.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到2级，花费700知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.lgb2;
		            			Position_12.x1=1023;Position_12.y1=198;
    		                    Position_11.level=2;
    	                        Position_12.level=2;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到3级，花费1000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.lgb3;
		            			Position_12.x1=1023;Position_12.y1=135;
    		                    Position_11.level=3;
    	                        Position_12.level=3;
    	                        PlayerTwo.Points=PlayerTwo.Points-1000;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到4级，花费1500知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.lgb4;
		            			Position_12.x1=1022;Position_12.y1=93;
    		                    Position_11.level=4;
    	                        Position_12.level=4;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级贤进楼到5级，花费2000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.lgb5;
		            			Position_12.x1=1023;Position_12.y1=83;
    		                    Position_11.level=5;
    	                        Position_12.level=5;
    	                        PlayerTwo.Points=PlayerTwo.Points-2000;
		            		...
		            		if(Position_12.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到2级，花费900知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.tyb2;
		            			Position_12.x1=1028;Position_12.y1=206;
    		                    Position_11.level=2;
    	                        Position_12.level=2;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到3级，花费1100知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.tyb3;
		            			Position_12.x1=1012;Position_12.y1=187;
    		                    Position_11.level=3;
    	                        Position_12.level=3;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到4级，花费2500知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.tyb4;
		            			Position_12.x1=1025;Position_12.y1=211;
    		                    Position_11.level=4;
    	                        Position_12.level=4;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级世纪馆到5级，花费4000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.tyb5;
		            			Position_12.x1=1022;Position_12.y1=171;
    		                    Position_11.level=5;
    	                        Position_12.level=5;
    	                        PlayerTwo.Points=PlayerTwo.Points-4000;
		            		...
		            		if(Position_12.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"获得拖堂卡一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到2级，花费400知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.gdb2;
		            			Position_12.x1=1029;Position_12.y1=158;
    		                    Position_11.level=2;
    	                        Position_12.level=2;
    	                        MainMap.baozi2=0;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"获得拖堂卡一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到3级，花费500知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.gdb3;
		            			Position_12.x1=1029;Position_12.y1=135;
    		                    Position_11.level=3;
    	                        Position_12.level=3;
    	                        MainMap.baozi2=0;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"获得考试周卡一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到4级，花费700知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.gdb4;
		            			Position_12.x1=1029;Position_12.y1=145;
    		                    Position_11.level=4;
    	                        Position_12.level=4;
    	                        MainMap.shoulei2=0;
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"获得一卡通一张","",JOptionPane.DEFAULT_OPTION);
		            			a=JOptionPane.showConfirmDialog(null,"升级实验室到5级，花费5000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.gdb5;Position_12.x1=1029;Position_12.y1=120;
    		                    Position_11.level=5;
    	                        Position_12.level=5;
    	                        MainMap.shaizi2=0;
    	                        PlayerTwo.Points=PlayerTwo.Points-5000;	
		            		...
		            		if(Position_12.level==1){
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到2级，花费2000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.red33;
		            			Position_12.x1=1029;Position_12.y1=164;
    		                    Position_11.level=2;
    	                        Position_12.level=2;
    	                        PlayerTwo.Points=PlayerTwo.Points-2000;	
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到3级，花费3000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.red44;
		            			Position_12.x1=1029;Position_12.y1=133;
    		                    Position_11.level=3;
    	                        Position_12.level=3;
    	                        PlayerTwo.Points=PlayerTwo.Points-3000;	
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到4级，花费5000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.red55;
		            			Position_12.x1=1029;Position_12.y1=71;
    		                    Position_11.level=4;
    	                        Position_12.level=4;
    	                        PlayerTwo.Points=PlayerTwo.Points-5000;	
		            			...
		            			a=JOptionPane.showConfirmDialog(null,"升级汇贤商店到5级，花费6000知识点","",JOptionPane.DEFAULT_OPTION);
		            			Position_12.image1=MainMap.red66;
		            			Position_12.x1=1028;Position_12.y1=39;
    		                    Position_11.level=5;
    	                        Position_12.level=5;
	    	...
	    	if(PlayerOne.step<50&&PlayerTwo.step<50){
	    		...
	    		h1.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				Position_12.x1=1025;Position_12.y1=205;
	    				...
	    				Position_12.level=1;
	    				if(PlayerOne.step==12){
	    					Position_12.image1=MainMap.red1;
	    					PlayerOne.Points=PlayerOne.Points-500;
	    					...
	    					Position_12.image1=MainMap.red11;
	    					PlayerTwo.Points=PlayerTwo.Points-500;
	    				}	
	    			}
	    		});
	    		...
	    		h2.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				Position_12.x1=1029;Position_12.y1=205;
	    				...
	    				if(PlayerOne.step==12){
	    					Position_11.color="red";
	    					Position_12.color="red";
	    					Position_12.image1=MainMap.tiyu1;
	    					PlayerOne.Points=PlayerOne.Points-900;
					    }
	    				else if(PlayerTwo.step==12){
	    					Position_11.color="blue";
	    					Position_12.color="blue";
	    					Position_12.image1=MainMap.tiyu2;
	    					PlayerTwo.Points=PlayerTwo.Points-900;
				        }
	    			}
	    		});
	    		...
	    		h3.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				Position_12.x1=1025;Position_12.y1=183;
	    				...
	    				if(PlayerOne.step==12){
	    					Position_11.color="red";
	    					Position_12.color="red";
	    					Position_12.image1=MainMap.park1;
	    				}
	    				else if(PlayerTwo.step==12){
	    					Position_11.color="blue";
	    					Position_12.color="blue";
	    					Position_12.image1=MainMap.park2;}
	    				}
	    			});
	    		...
	    		h4.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				...
	    				if(PlayerOne.step==12){
	    					Position_11.color="red";
	    					Position_12.color="red";
	    					Position_12.image1=MainMap.gdt1;
	    					PlayerOne.Points=PlayerOne.Points-300;
	    				}
	    				else if(PlayerTwo.step==12){
	    					Position_11.color="blue";
	    					Position_12.color="blue";
	    					Position_12.image1=MainMap.gdt2;
	    		...
	    		h5.addActionListener(new ActionListener(){
	    			public void actionPerformed(ActionEvent e){
	    				Position_12.x1=1027;Position_12.y1=163;
	    				...
	    				if(PlayerOne.step==12){
	    					Position_11.color="red";
	    					Position_12.color="red";
	    					Position_12.image1=MainMap.red2;
	    					PlayerOne.Points=PlayerOne.Points-1000;
					    }
	    				else if(PlayerTwo.step==12){
	    					Position_11.color="blue";
	    					Position_12.color="blue";
	    					Position_12.image1=MainMap.red22;
	    					PlayerTwo.Points=PlayerTwo.Points-1000;
				        }
	    			}
	    		});
	...
	public static void drawQY5Image(Graphics g)
    {
    	g.drawImage(Position_12.image1,Position_12.x1,Position_12.y1,null);
    }
}